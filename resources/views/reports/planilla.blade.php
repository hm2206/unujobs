                ...
                <div class="page-only pt-2">
                    <div>
                        ...
                        <table class="w-100 table-sm uppercase">
                            <tr>
                                <th class="py-0 font-12">OBS:</th>
                                <th class="font-12"><b>MES DE {{ $meses[$meta->mes - 1] }}-{{ $meta->year }}</b></th>
                                <th class="font-12">META SIAF: {{ $meta->metaID }}</th>
                                <td class="font-12"></td>
                                <td class="font-12"></td>
                                <th class="font-12">Página N° {{ $pagina++ }}</th>
                            </tr>
                        </table>
                    </div>
                        ...
                        @foreach ($historial as $history)
                            ...
                            <table class="table-sm w-100 uppercase">
                                <thead class="bbt-1 bbb-1">
                                    <tr>
                                        <th class="py-0 font-12">CODIGO {{ $history->id }} </th>
                                        <th class="py-0 font-12">PLAZA {{ $history->plaza }}</th>
                                        <th class="py-0 font-12">DEDICACION</th>
                                        <th class="py-0 font-12" colspan="2">AFP {{ $history->afp ? $history->afp->nombre : "" }}</th>
