        ...
        <table class="table mt-2 table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="py-1 text-right"><small>Total Bruto</small></th>
                    <th class="py-1 text-right"><small>Base Imponible</small></th>
                    <th class="py-1 text-right"><small>Total Descuento</small></th>
                    <th class="py-1 text-right"><small>Total Neto</small></th>
                </tr>
            </thead>
            @foreach ($works as $work)
                <tbody>
                   @foreach ($work->tmp_infos as $info)
                        <tr>
                            <td class="py-1"><small class="font-12">{{ $info->count }}</small></td>
                            ...
                            <td class="py-1 text-right"><small class="font-12">{{ $info->total_bruto }}</small></td>
                            <td class="py-1 text-right"><small class="font-12 text-right">{{ $info->base_imponible }}</small></td>
                            <td class="py-1 text-right"><small class="font-12 text-right">{{ $info->total_descuentos }}</small></td>
                            <td class="py-1 text-right"><small class="font-12 text-right">{{ $info->total_neto }}</small></td>
                        </tr>
                   @endforeach
                </tbody>
            @endforeach
