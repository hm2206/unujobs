                    ...
                    <tbody>
                        <tr>
                            <td class="bbr-1 p-relative">
                                <table class="w-100">
                                    <tbody>
                                        @foreach ($work->cronograma->remuneraciones as $remuneracion)
                                            <tr>
                                                <td class="py-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right bbt-1">
                                                {{ $work->cronograma->remuneraciones->sum('monto') }}
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <td class="p-relative">
                                <table class="p-absolute top-0 w-100">
                                    <tbody>
                                        @foreach ($work->cronograma->descuentos as $body)
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="py-0 bbt-1 text-center" colspan="3">
                                                {{ $work->cronograma->total_descuento }}
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="py-0">NETO A PAGAR</th>
                                            <th class="py-0 bbt-1 text-center" colspan="3">
                                                {{ $work->cronograma->neto }}
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <td class="bbl-1 p-relative">
                                <table class="p-absolute top-0 w-100">
                                    <tr>
                                        ...
                                        <td class="py-0">{{ $work->cronograma->essalud }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-0">{{ $work->cronograma->accidentes }}</td>
                                    </tr>
                                    <tr>
                                        <td class="py-0">84.-TOTAL APORTE</td>
                                        <td class="py-0 bbt-1">{{ $work->cronograma->total_aportes }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-0">{{ $work->cronograma->base }}</td>
                                    </tr>
                                    @for ($i = 0; $i < 15; $i++)
                                        <tr>
                                            <td></td>
