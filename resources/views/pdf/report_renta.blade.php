...
<html lang="es">
    ...
    <body class="bg-white text-negro" style="height: 100%;">

                <div class="p-relative m-height-100">
                    ...
                    <div class="w-100 py-0" style="margin: 0px; padding: 0px;">
                    ...
                    <div class="p-absolute bottom-0 left-0 bbt-1 bbb-1">
                        <table class="w-100">
                            <thead class="py-0">
                                <tr class="py-0">
