    ...
    <span>
        ...
        <modal :show="show" @close="show = false">
            ...
            <template slot="content">
                <form class="card-body scroll-y" style="font-size: 16px;" id="vaciar-descuentos" v-on:submit="send">
...
export default {
    ...
    methods: {
        ...
        async send(e) {
            ...
            if (answer) {
                const form = new FormData(document.getElementById('vaciar-descuentos'));
                let api = unujobs('post', `/cronograma/${this.cronograma.id}/vaciar-descuentos`, form);
                await api.then(res => {
